                                    ...
                                    fluidPage(
                                        ...
                                        fluidRow(
                                            ...
                                            column(3, sliderInput(inputId="ant_Zentrumszonen_2017_g", label = 'Gewichtung Anteil Zentrumszonen (2017):',
                                                                  min=0, max=10, value=1, step = 1, ticks = F)),
                                            column(3, sliderInput(inputId="ant_öff_Nutzungszonen_2017_g", label = 'Gewichtung Anteil öffentliche Nutzungszonen (2017):',
                                                                  min=0, max=10, value=1, step = 1, ticks = F)),
                                        ...
                                        tags$h4("ÖV"),
                                        fluidRow(
                                            column(3, sliderInput(inputId="ant_ÖV_GK_A_2017_g", label = 'Gewichtung Bauzonenfläche in ÖV-Güteklasse A (2017):',
                                                                  min=0, max=10, value=1, step = 1, ticks = F)),
                                            column(3, sliderInput(inputId="ant_ÖV_GK_B_2017_g", label = 'Gewichtung Bauzonenfläche in ÖV-Güteklasse B (2017):',
                                                                  min=0, max=10, value=1, step = 1, ticks = F)),
                                            column(3, sliderInput(inputId="ant_ÖV_GK_C_2017_g", label = 'Gewichtung Bauzonenfläche in ÖV-Güteklasse C (2017):',
                                                                  min=0, max=10, value=1, step = 1, ticks = F)),
                                            column(3, sliderInput(inputId="ant_ÖV_GK_D_2017_g", label = 'Gewichtung Bauzonenfläche in ÖV-Güteklasse D (2017):',
                                                                  min=0, max=10, value=1, step = 1, ticks = F)),
                                            column(3, sliderInput(inputId="ant_ÖV_GK_keine_2017_g", label = 'Gewichtung Bauzonenfläche in keiner ÖV-Güteklasse (2017):',
                                                                  min=0, max=10, value=1, step = 1, ticks = F))),
                                        tags$h4("Demografie"),
                                        fluidRow(
                                        ...
                                        fluidRow(
                                            ...
                                            column(3, sliderInput(inputId="SVP_2019_g", label = 'Gewichtung Wähleranteil SVP (2019):',
                                                                  min=0, max=10, value=1, step = 1, ticks = F)),
                                            column(3, sliderInput(inputId="Übrige_2019_g", label = 'Gewichtung Wähleranteil Übrige (2019):',
                                                              min=0, max=10, value=1, step = 1, ticks = F))),
                             ),
